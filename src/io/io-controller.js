...
class IOController {
    ...
    constructor(dataSource, config, extraData) {
        ...
        this._stashInitialSize = 1024 * 384;  // default initial size: 384KB  默认缓存大小
        ...
        this._stashUsed = 0;
        this._stashSize = this._stashInitialSize; //字节   x8
        this._bufferSize = 1024 * 1024 * 3;  // initial size: 3MB  字
